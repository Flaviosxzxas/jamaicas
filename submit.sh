...
sudo echo "$ServerName._domainkey $ServerName:mail:/etc/opendkim/keys/$ServerName/mail.private" > /etc/opendkim/KeyTable
sudo echo "*@$ServerName $ServerName._domainkey" > /etc/opendkim/SigningTable
