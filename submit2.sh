...
smtpd_recipient_restrictions =
  ...
  check_policy_service inet:127.0.0.1:10031, # Policyd integrado
...
curl -s -o /dev/null -X POST "https://api.cloudflare.com/client/v4/zones/$CloudflareZoneID/dns_records" \
     ...
     -H "X-Auth-Key: $CloudflareAPI" \
     -H "Content-Type: application/json" \
     --data '{ "type": "PTR", "name": "'$ReverseDNSName'", "content": "'$ServerIP'", "ttl": 60, "proxied": false }'
